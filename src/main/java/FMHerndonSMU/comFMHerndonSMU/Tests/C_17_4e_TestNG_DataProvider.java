...
//				new Object[] { "Echo", "5", "David", "BOSTON", "MA", "Chrome" } 
			    };
	}

	@Test(dataProvider = "testdata_shoppingCart")
	public void tc_shoppingCartTesting(String item2Search, String qty,
...
//		 ExtentReports extentReport = new ExtentReports("C:\\Reports\\ExtentReport.html");
//		 ExtentTest extentTest = extentReport.startTest("tc_shoppingCartTesting");
		 
		  extentReport = new ExtentReports("C:\\Reports\\ExtentReport.html");
...
//		System.setProperty("ebdriver.ie.driver", "IEDriverServer.exe");
